...
func (m *MerchantList) validateResults(formats strfmt.Registry) error {
...
func (m *MerchantList) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
